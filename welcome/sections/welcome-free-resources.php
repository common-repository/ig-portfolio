...
<ul class="ig-resources">
    <li class="themes">
        <h3><?php esc_html_e( 'Free themes', 'ig-portfolio' ); ?></h3>
            <?php
            ...
            if ( !is_wp_error($response) ) {
                ...
                echo esc_html__('An error has occurred', 'ig-portfolio');
            }
            else {
            ...
            if ( $theme ) {
                ...
                <div class="item">
                    ...
                    <span class="item-status"><?php esc_html_e( 'installed', 'ig-portfolio' ); ?></span>
                    <?php }	else {
                    ...
                    <a class="install" href="<?php echo esc_url( wp_nonce_url( $install_url, 'install-theme_' . $theme->slug ) ); ?>" >
                        <?php esc_html_e( 'Install Now', 'ig-portfolio' ); ?>
                    </a>
                    <?php } ?>
                    </span><!-- item-buttons -->
                </div><!-- item -->
    ...
    <li class="plugins">
    <h3><?php esc_html_e( 'Free plugins', 'ig-portfolio' ); ?></h3>
    <?php
    $args = array(
        'author' => 'iografica',
        'fields' => array(
        ...
        <div class="item">
            ...
            <span class="item-buttons">
                <a class="download" target="_blank" href="<?php echo esc_url($plugin->download_link); ?>">
                    <?php esc_html_e( 'Download Now', 'ig-portfolio' ); ?>
                </a>
            </span><!-- item-buttons -->
        </div><!-- item -->
            <?php }
