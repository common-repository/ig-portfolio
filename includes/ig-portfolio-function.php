...
//IMAGE SIZE
add_action( 'init', 'ig_portfolio_new_image_size' );
function ig_portfolio_new_image_size() {
    add_image_size( 'img-thumb', get_option('ig_portfolio_thumb_width', '1024'), get_option('ig_portfolio_thumb_height', '350'), true ); //cropped
    add_image_size( 'img-gallery', get_option('ig_portfolio_gallery_img_width', '554'), get_option('ig_portfolio_gallery_img_height', '454'), true ); //cropped
}
